...
data_path = os.path.abspath(os.path.join(_BASE_DIR, '../../data/Taobao/')) + '/'
train_path = data_path + 'first_seven/training_list.npy'
valid_path = data_path + 'first_seven/validation_dict.npy'
user_feat_path = data_path + 'first_seven/user_feature.npy'

week_train_path = data_path + 'last_three/training_list.npy'
week_test_path = data_path + 'last_three/testing_dict.npy'
week_user_feat_path = data_path + 'last_three/user_feature.npy'
